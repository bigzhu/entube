...
const Map<Symbol, dynamic> configSupabase = {
  ...
  Symbol('anonKey'):
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InBqbXpmZ3Bnc2Job3hoc2dxaXF5Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NTM5OTMyNjEsImV4cCI6MTk2OTU2OTI2MX0.t2xB3FKXXVO0rGWVVKAFBEHBm7V4K3skBPppkoWudKg',
  Symbol('authCallbackUrlHostname'): 'login-callback', // optional
  Symbol('debug'): true // optional
};
