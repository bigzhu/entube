...
const UserArticleItems = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'UserArticleItems'),
  variableDefinitions: [],
  directives: [],
...
const document = _i1.DocumentNode(definitions: [UserArticleItems]);
