...
Serializer<GArticleByUrlReq> _$gArticleByUrlReqSerializer =
    new _$GArticleByUrlReqSerializer();
...
class _$GArticleByUrlReqSerializer
    implements StructuredSerializer<GArticleByUrlReq> {
  @override
  final Iterable<Type> types = const [GArticleByUrlReq, _$GArticleByUrlReq];
  @override
  final String wireName = 'GArticleByUrlReq';

  @override
  Iterable<Object?> serialize(Serializers serializers, GArticleByUrlReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GArticleByUrlVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
      'executeOnListen',
    ...
    if (value != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GArticleByUrlData)));
    }
    value = object.updateCacheHandlerKey;
    if (value != null) {
      result
  ...
  @override
  GArticleByUrlReq deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GArticleByUrlReqBuilder();
...
class _$GArticleByUrlReq extends GArticleByUrlReq {
  @override
  final _i3.GArticleByUrlVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GArticleByUrlData? Function(
      _i2.GArticleByUrlData?, _i2.GArticleByUrlData?)? updateResult;
  @override
  final _i2.GArticleByUrlData? optimisticResponse;
  @override
  final String? updateCacheHandlerKey;
  @override
  final Map<String, dynamic>? updateCacheHandlerContext;
  ...
  factory _$GArticleByUrlReq(
          [void Function(GArticleByUrlReqBuilder)? updates]) =>
      (new GArticleByUrlReqBuilder()..update(updates))._build();

  _$GArticleByUrlReq._(
      {required this.vars,
      required this.operation,
      this.requestId,
      this.updateResult,
      ...
      required this.executeOnListen})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GArticleByUrlReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GArticleByUrlReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GArticleByUrlReq', 'executeOnListen');
  }

  @override
  GArticleByUrlReq rebuild(void Function(GArticleByUrlReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GArticleByUrlReqBuilder toBuilder() =>
      new GArticleByUrlReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is GArticleByUrlReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == _$dynamicOther.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GArticleByUrlReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GArticleByUrlReqBuilder
    implements Builder<GArticleByUrlReq, GArticleByUrlReqBuilder> {
  _$GArticleByUrlReq? _$v;

  _i3.GArticleByUrlVarsBuilder? _vars;
  _i3.GArticleByUrlVarsBuilder get vars =>
      _$this._vars ??= new _i3.GArticleByUrlVarsBuilder();
  set vars(_i3.GArticleByUrlVarsBuilder? vars) => _$this._vars = vars;
  ...
  _i2.GArticleByUrlData? Function(
      _i2.GArticleByUrlData?, _i2.GArticleByUrlData?)? _updateResult;
  _i2.GArticleByUrlData? Function(
          _i2.GArticleByUrlData?, _i2.GArticleByUrlData?)?
      get updateResult => _$this._updateResult;
  set updateResult(
          _i2.GArticleByUrlData? Function(
                  _i2.GArticleByUrlData?, _i2.GArticleByUrlData?)?
  ...
  _i2.GArticleByUrlDataBuilder? _optimisticResponse;
  _i2.GArticleByUrlDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= new _i2.GArticleByUrlDataBuilder();
  set optimisticResponse(_i2.GArticleByUrlDataBuilder? optimisticResponse) =>
      _$this._optimisticResponse = optimisticResponse;
  ...
  GArticleByUrlReqBuilder() {
    GArticleByUrlReq._initializeBuilder(this);
  }

  GArticleByUrlReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void replace(GArticleByUrlReq other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GArticleByUrlReq;
  }

  @override
  void update(void Function(GArticleByUrlReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GArticleByUrlReq build() => _build();

  _$GArticleByUrlReq _build() {
    _$GArticleByUrlReq _$result;
    try {
      _$result = _$v ??
          new _$GArticleByUrlReq._(
              vars: vars.build(),
              operation: BuiltValueNullFieldError.checkNotNull(
                  operation, r'GArticleByUrlReq', 'operation'),
              requestId: requestId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GArticleByUrlReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
