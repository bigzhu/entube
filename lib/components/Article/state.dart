    ...
    await for (final value in stream) {
      ...
      if (article != null) {
        ...
        if (sentencesJson == null) {
          ...
          if (captions['sentences_type'] == 'generated') {
            EasyLoading.showInfo(
                'The video captions are automatically generated by AI and may contain some inaccuracies.');
          } else {
            EasyLoading.dismiss();
          }
          // 删除缓存
          ...
          if (article.sentences_type == 'generated') {
            EasyLoading.showInfo(
                'The video captions are automatically generated by AI and may contain some inaccuracies.',
