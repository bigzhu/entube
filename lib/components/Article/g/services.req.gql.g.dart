...
Serializer<GupdateSentencesReq> _$gupdateSentencesReqSerializer =
    new _$GupdateSentencesReqSerializer();
...
class _$GupdateSentencesReqSerializer
    implements StructuredSerializer<GupdateSentencesReq> {
  @override
  final Iterable<Type> types = const [
    GupdateSentencesReq,
    _$GupdateSentencesReq
  ];
  @override
  final String wireName = 'GupdateSentencesReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GupdateSentencesReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GupdateSentencesVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
      'executeOnListen',
    ...
    if (value != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GupdateSentencesData)));
    }
    value = object.updateCacheHandlerKey;
    if (value != null) {
      result
  ...
  @override
  GupdateSentencesReq deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GupdateSentencesReqBuilder();
...
class _$GupdateSentencesReq extends GupdateSentencesReq {
  @override
  final _i3.GupdateSentencesVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GupdateSentencesData? Function(
      _i2.GupdateSentencesData?, _i2.GupdateSentencesData?)? updateResult;
  @override
  final _i2.GupdateSentencesData? optimisticResponse;
  @override
  final String? updateCacheHandlerKey;
  @override
  final Map<String, dynamic>? updateCacheHandlerContext;
  ...
  factory _$GupdateSentencesReq(
          [void Function(GupdateSentencesReqBuilder)? updates]) =>
      (new GupdateSentencesReqBuilder()..update(updates))._build();

  _$GupdateSentencesReq._(
      {required this.vars,
      required this.operation,
      this.requestId,
      this.updateResult,
      ...
      required this.executeOnListen})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GupdateSentencesReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GupdateSentencesReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GupdateSentencesReq', 'executeOnListen');
  }

  @override
  GupdateSentencesReq rebuild(
          void Function(GupdateSentencesReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GupdateSentencesReqBuilder toBuilder() =>
      new GupdateSentencesReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is GupdateSentencesReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == _$dynamicOther.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GupdateSentencesReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GupdateSentencesReqBuilder
    implements Builder<GupdateSentencesReq, GupdateSentencesReqBuilder> {
  _$GupdateSentencesReq? _$v;

  _i3.GupdateSentencesVarsBuilder? _vars;
  _i3.GupdateSentencesVarsBuilder get vars =>
      _$this._vars ??= new _i3.GupdateSentencesVarsBuilder();
  set vars(_i3.GupdateSentencesVarsBuilder? vars) => _$this._vars = vars;
  ...
  _i2.GupdateSentencesData? Function(
      _i2.GupdateSentencesData?, _i2.GupdateSentencesData?)? _updateResult;
  _i2.GupdateSentencesData? Function(
          _i2.GupdateSentencesData?, _i2.GupdateSentencesData?)?
      get updateResult => _$this._updateResult;
  set updateResult(
          _i2.GupdateSentencesData? Function(
                  _i2.GupdateSentencesData?, _i2.GupdateSentencesData?)?
  ...
  _i2.GupdateSentencesDataBuilder? _optimisticResponse;
  _i2.GupdateSentencesDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= new _i2.GupdateSentencesDataBuilder();
  set optimisticResponse(_i2.GupdateSentencesDataBuilder? optimisticResponse) =>
      _$this._optimisticResponse = optimisticResponse;
  ...
  GupdateSentencesReqBuilder() {
    GupdateSentencesReq._initializeBuilder(this);
  }

  GupdateSentencesReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void replace(GupdateSentencesReq other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GupdateSentencesReq;
  }

  @override
  void update(void Function(GupdateSentencesReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GupdateSentencesReq build() => _build();

  _$GupdateSentencesReq _build() {
    _$GupdateSentencesReq _$result;
    try {
      _$result = _$v ??
          new _$GupdateSentencesReq._(
              vars: vars.build(),
              operation: BuiltValueNullFieldError.checkNotNull(
                  operation, r'GupdateSentencesReq', 'operation'),
              requestId: requestId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GupdateSentencesReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
